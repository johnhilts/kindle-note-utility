...
- [ ] Come up with more object oriented way to retrieve web-user info.
  - [ ] Use a different class just for registration / authentication.
    - We don't want to read in the password unnecessarily!
  - [ ] Need to think some more how exactly to design this.
